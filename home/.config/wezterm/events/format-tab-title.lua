...
function M.setup()
	wez.on("format-tab-title", function(tab, _, _, config, hover, max_width)
		local edge_bg = theme.background
		local bg = theme.light_background
		local fg = theme.ansi[8]
